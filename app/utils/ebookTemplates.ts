export function gerarPaginaAviso(livroTitulo: string) {
  // ADICIONADO .chapter-text-page PARA HERDAR AS MARGENS PADRÃO DO E-BOOK
  return `
...
4. REGRA DE SEGURANÇA MÁXIMA E ABSOLUTA: É ESTRITAMENTE PROIBIDO gerar qualquer pensamento interno, comentários, notas, rascunhos, textos explicativos (como "Aqui está o capítulo..."), contagem de palavras, ou raciocínios lógicos (como "Wait", "Let's check"). RETORNE ÚNICA E EXCLUSIVAMENTE AS TAGS HTML DO E-BOOK E ABSOLUTAMENTE NADA MAIS.
